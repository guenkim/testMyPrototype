...
public class ReqItemDto {
    ...
    @JsonCreator
    public ReqItemDto(@JsonProperty("name") String name, @JsonProperty("price") int price, @JsonProperty("stockQuanitty") int stockQuanitty, @JsonProperty("batType") BatType batType, @JsonProperty("ticker") String ticker, @JsonProperty("company") String company, @JsonProperty("categories") List<ReqItemDto.Category> categories) {
        this.name = name;
        this.price = price;
